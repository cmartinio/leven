...
wp_enqueue_style('leven-main-styles', get_template_directory_uri().'/css/main.css',array(),$theme_version);

if ( class_exists( 'WooCommerce' ) ) {
	wp_enqueue_style('leven-woocommerce', get_template_directory_uri().'/css/woocommerce.css',array(),$theme_version);
}

$theme_style = ( function_exists('fw_get_db_settings_option') ) ? fw_get_db_settings_option('theme_style_picker') :  'light';
if( $theme_style == 'dark' ) {
    wp_enqueue_style('leven-dark-styles', get_template_directory_uri().'/css/dark-styles.css',array(),$theme_version);
}

wp_enqueue_style('leven-customization', get_template_directory_uri().'/css/customization.css',array(),$theme_version);
...
wp_enqueue_script('leven-jquery-main', get_template_directory_uri().'/js/main.js',array(),$theme_version,true);
