...
?>  
            ...
            <footer class="site-footer clearfix">
                ...
                <div class="footer-contact">
                    <a href="mailto:contact@cmartn.com"><i class="fa fa-shield"></i> contact@cmartn.com</a><a href="https://keys.openpgp.org/search?q=cmartn%40proton.me" class="pgp-key-link" target="_blank"><i class="fa fa-key"></i> PGP</a>
                    <a href="mailto:cmartn@pm.me"><i class="fa fa-shield"></i> cmartn@pm.me</a><a href="https://keys.openpgp.org/search?q=cmartn%40proton.me" class="pgp-key-link" target="_blank"><i class="fa fa-key"></i> PGP</a>
                </div>
                <?php } ?>
            </footer>
            <?php } ?>
